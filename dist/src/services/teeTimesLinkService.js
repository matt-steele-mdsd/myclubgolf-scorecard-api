...
async function getLinkedEventId(eventId) {
    const [forwardRows] = await config_1.default.query(`SELECT
    ...
    const [reverseRows] = await config_1.default.query(`SELECT eo1.EventID AS partnerId
